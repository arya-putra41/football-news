...
# Function to show full news article
@login_required(login_url="/login/")
...
# Function to edit news article (if user is author)
...
# Function to delete article (if user is author)
def delete_news(request, id):
    news = get_object_or_404(News, pk=id)
    news.delete()
    return HttpResponseRedirect(reverse('main:show_main'))

# Function to show and process registration form
